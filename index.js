...
async function init_game_env() {
	...
	if (firebase.apps.length===0) {
		firebase.initializeApp({
			apiKey: "AIzaSyAjT6YevDoIAwsWmfGX1oJqL9qHMFoRxqY",
			authDomain: "brain-battle-346bc.firebaseapp.com",
			databaseURL: "https://brain-battle-346bc-default-rtdb.europe-west1.firebasedatabase.app",
			projectId: "brain-battle-346bc",
			storageBucket: "brain-battle-346bc.appspot.com",
			messagingSenderId: "144012011677",
			appId: "1:144012011677:web:9a95e863b98a667e7e4c74"
		});
	}	
